...
public class HeroController {
    ...
    @GetMapping("/search")
    public ResponseEntity<Object> getHeroByAnything(@RequestParam String value){
//        return null;
        return ResponseEntity.ok(heroRepository.getByAnything(value, PageRequest.of(0,2)));
    }
